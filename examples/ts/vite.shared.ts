...
export const unitflowAliases: AliasOptions = [
  { find: "@unitflow/devtools/bridge", replacement: fromRoot("packages/devtools/src/bridge.ts") },
  { find: "@unitflow/devtools", replacement: fromRoot("packages/devtools/src/index.ts") },
